# EduAI - Your Personalized AI Learning Assistant
...
After putting up the details in Signup Page, Restart the application go to login Page and put the details to get logged in into the application.
---
